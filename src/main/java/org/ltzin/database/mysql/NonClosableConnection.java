...
/**
 * Wrapper que impede que código externo feche a conexão subjacente.
 * O método close() é intencionalmente um no-op; quem gerencia o ciclo
 * de vida real é MySQLDatabase.shutdown().
 *
 * isClosed() delega para o delegate real — assim quem usa try-with-resources
 * recebe a informação correta sobre o estado da conexão.
 */
