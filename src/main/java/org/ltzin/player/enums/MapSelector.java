...
public enum MapSelector {
    ...
    private static final MapSelector[] VALUES = values();

    public static MapSelector getByOrdinal(long ordinal) {
    ...
    public MapSelector next() { return this == TODOS ? NENHUM : TODOS; }
}