...
public enum LobbyJoinMessages {

    TODOS,
    NENHUM;

    private static final LobbyJoinMessages[] VALUES = values();

    public static LobbyJoinMessages getByOrdinal(long ordinal) {
    ...
    public LobbyJoinMessages next() { return this == TODOS ? NENHUM : TODOS; }
}